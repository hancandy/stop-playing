 ...
 */
UCLASS()
class STOPPLAYING_API UNinjaCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UPROPERTY(Category = "Ninja Character Movement", BlueprintReadWrite, EditAnywhere)
...
protected:
	 ...
	 */
	UPROPERTY(Category = "Ninja Character Movement", VisibleAnywhere)
...
public:
	 ...
	 */
	UFUNCTION(Category = "Pawn|Components|NinjaCharacterMovement", BlueprintCallable)
