...
StopPlayingRootPath=/home/mrzapp/Development/Game/StopPlaying

gameProjectFile=/home/mrzapp/Development/Game/StopPlaying/StopPlaying.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(StopPlayingSource.pri)
include(StopPlayingHeader.pri)
include(StopPlayingConfig.pri)
include(StopPlayingIncludes.pri)
include(StopPlayingDefines.pri)
...
StopPlaying-Linux-Debug.commands = $$build StopPlaying Linux Debug  -project="\"$$gameProjectFile\"" $$args
StopPlaying-Linux-DebugGame.commands = $$build StopPlaying Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
StopPlaying-Linux-Shipping.commands = $$build StopPlaying Linux Shipping  -project="\"$$gameProjectFile\"" $$args
StopPlaying-Linux-Test.commands = $$build StopPlaying Linux Test  -project="\"$$gameProjectFile\"" $$args
StopPlaying.commands = $$build StopPlaying Linux Development  -project="\"$$gameProjectFile\"" $$args

StopPlayingEditor-Linux-Debug.commands = $$build StopPlayingEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
StopPlayingEditor-Linux-DebugGame.commands = $$build StopPlayingEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
StopPlayingEditor-Linux-Shipping.commands = $$build StopPlayingEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
StopPlayingEditor-Linux-Test.commands = $$build StopPlayingEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
StopPlayingEditor.commands = $$build StopPlayingEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	StopPlaying-Linux-Debug \
	StopPlaying-Linux-DebugGame \
	StopPlaying-Linux-Shipping \
	StopPlaying-Linux-Test \
	StopPlaying \
	StopPlayingEditor-Linux-Debug \
	StopPlayingEditor-Linux-DebugGame \
	StopPlayingEditor-Linux-Shipping \
	StopPlayingEditor-Linux-Test \
	StopPlayingEditor \
