...
ShaderCacheTool-Linux-Debug:
	 $(BUILD) ShaderCacheTool Linux Debug  $(ARGS)

ShaderCacheTool-Linux-DebugGame:
	 $(BUILD) ShaderCacheTool Linux DebugGame  $(ARGS)

ShaderCacheTool-Linux-Shipping:
	 $(BUILD) ShaderCacheTool Linux Shipping  $(ARGS)

ShaderCacheTool-Linux-Test:
	 $(BUILD) ShaderCacheTool Linux Test  $(ARGS)

ShaderCacheTool:
	 $(BUILD) ShaderCacheTool Linux Development  $(ARGS)
...
StopPlaying-Linux-Debug:
	 $(PROJECTBUILD) StopPlaying Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlaying-Linux-DebugGame:
	 $(PROJECTBUILD) StopPlaying Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlaying-Linux-Shipping:
	 $(PROJECTBUILD) StopPlaying Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlaying-Linux-Test:
	 $(PROJECTBUILD) StopPlaying Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlaying:
	 $(PROJECTBUILD) StopPlaying Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlayingEditor-Linux-Debug:
	 $(PROJECTBUILD) StopPlayingEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlayingEditor-Linux-DebugGame:
	 $(PROJECTBUILD) StopPlayingEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlayingEditor-Linux-Shipping:
	 $(PROJECTBUILD) StopPlayingEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlayingEditor-Linux-Test:
	 $(PROJECTBUILD) StopPlayingEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

StopPlayingEditor:
	 $(PROJECTBUILD) StopPlayingEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
